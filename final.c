			...
			if (request[0] == response[0])
			{
				...
				if (numbytes >= 0) 
				{
					...
					numbytes = (int)write(clie_sock_fd, response3, strlen(response3));
						...
						{
						printf("Content-type: text/html\r\n\n");
						printf("<html><head>FAIL</head><body><h1>fail10</h1></body></html>\n");
						}
					}
					else
					{		
					printf("Content-type: text/html\r\n\n");
					printf("<html><head>FAIL</head><body><h1>fail11</h1></body></html>\n");
					}
				}
				else
				{
				printf("Content-type: text/html\r\n\n");
				printf("<html><head>FAIL</head><body><h1>fail12</h1></body></html>\n");
				}
			}
			else
			{						
