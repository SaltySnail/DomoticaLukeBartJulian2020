...
int main()
{
        ...
        int serv_sock_fd, clie_sock_fd, bind_succeeded, listen_succeeded, numbytes, serv_port = 60003, mariaid;
        socklen_t clen;
                                ...
                                else
                                {
                                        ...
                                        printf("Een Q kost: %d\n", numbytes);
                                                ...
                                                else
                                                {
                                                        ...
                                                        //mariaid = 0;
                                                        snprintf(query, 512, "INSERT INTO dht VALUES ('%d', '%f')", mariaid, temp);
